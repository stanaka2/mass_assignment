...
static void bind_dtype(py::module_ &m)
{
  ...
  m.def(
      ...
      [](py::array_t<T, py::array::c_style> pos, py::array_t<T, py::array::c_style> mass, double lbox, int nmesh,
         int method, int nthreads, std::string dtype) -> py::object {
        int64_t n = pos.shape(0);
        if(parse_out_kind(dtype) == OutKind::F32)
          return density_impl<T, float>(pos.data(), mass.data(), n, lbox, nmesh, method, nthreads);
        else return density_impl<T, double>(pos.data(), mass.data(), n, lbox, nmesh, method, nthreads);
      },
  ...
  m.def(
      ...
      [](py::array_t<T, py::array::c_style> pos, py::array_t<T, py::array::c_style> vel,
         py::array_t<T, py::array::c_style> mass, double lbox, int nmesh, int method, int nthreads,
         std::string dtype) -> py::object {
        int64_t n = pos.shape(0);
        if(parse_out_kind(dtype) == OutKind::F32)
          return velocity_impl<T, float>(pos.data(), vel.data(), mass.data(), n, lbox, nmesh, method, nthreads);
        else return velocity_impl<T, double>(pos.data(), vel.data(), mass.data(), n, lbox, nmesh, method, nthreads);
      },
  ...
  m.def(
      ...
      [](py::array_t<T, py::array::c_style> pos, py::array_t<T, py::array::c_style> vel,
        ...
        if(parse_out_kind(dtype) == OutKind::F32)
          ...
          return velocity_norm_impl<T, double>(pos.data(), vel.data(), mass.data(), n, lbox, nmesh, method, nthreads);
      },
      py::arg("pos"), py::arg("vel"), py::arg("mass"), py::arg("lbox"), py::arg("nmesh"), py::arg("method") = 3,
      py::arg("nthreads") = 0, py::arg("dtype") = "f4");
  ...
  m.def(
      ...
      [](py::array_t<T, py::array::c_style> pos, py::array_t<T, py::array::c_style> vel,
        ...
        else return sigma_impl<T, double>(pos.data(), vel.data(), mass.data(), n, lbox, nmesh, method, nthreads);
      },
      py::arg("pos"), py::arg("vel"), py::arg("mass"), py::arg("lbox"), py::arg("nmesh"), py::arg("method") = 3,
      py::arg("nthreads") = 0, py::arg("dtype") = "f4");
  ...
  m.def(
      "sigma_norm",
      [](py::array_t<T, py::array::c_style> pos, py::array_t<T, py::array::c_style> vel,
         py::array_t<T, py::array::c_style> mass, double lbox, int nmesh, int method, int norm_mode, int nthreads,
         std::string dtype) -> py::object {
        int64_t n = pos.shape(0);
        if(parse_out_kind(dtype) == OutKind::F32)
          ...
          return sigma_norm_impl<T, double>(pos.data(), vel.data(), mass.data(), n, lbox, nmesh, method, nthreads,
                                            norm_mode);
      },
      py::arg("pos"), py::arg("vel"), py::arg("mass"), py::arg("lbox"), py::arg("nmesh"), py::arg("method") = 3,
      py::arg("norm_mode") = 1, py::arg("nthreads") = 0, py::arg("dtype") = "f4");
  ...
  m.def(
      ...
      [](py::array_t<T, py::array::c_style> pos, py::array_t<T, py::array::c_style> vel,
        ...
        else return skewness_impl<T, double>(pos.data(), vel.data(), mass.data(), n, lbox, nmesh, method, nthreads);
      },
      py::arg("pos"), py::arg("vel"), py::arg("mass"), py::arg("lbox"), py::arg("nmesh"), py::arg("method") = 3,
      py::arg("nthreads") = 0, py::arg("dtype") = "f4");
  ...
  m.def(
      ...
      [](py::array_t<T, py::array::c_style> pos, py::array_t<T, py::array::c_style> vel,
        ...
        if(parse_out_kind(dtype) == OutKind::F32)
          ...
          return skewness_norm_impl<T, double>(pos.data(), vel.data(), mass.data(), n, lbox, nmesh, method, nthreads,
                                               norm_mode);
      },
      py::arg("pos"), py::arg("vel"), py::arg("mass"), py::arg("lbox"), py::arg("nmesh"), py::arg("method") = 3,
      py::arg("norm_mode") = 1, py::arg("nthreads") = 0, py::arg("dtype") = "f4");
  ...
  m.def(
      ...
      [](py::array_t<T, py::array::c_style> pos, py::array_t<T, py::array::c_style> vel,
        ...
        else return kurtosis_impl<T, double>(pos.data(), vel.data(), mass.data(), n, lbox, nmesh, method, nthreads);
      },
      py::arg("pos"), py::arg("vel"), py::arg("mass"), py::arg("lbox"), py::arg("nmesh"), py::arg("method") = 3,
      py::arg("nthreads") = 0, py::arg("dtype") = "f4");
  ...
  m.def(
      ...
      [](py::array_t<T, py::array::c_style> pos, py::array_t<T, py::array::c_style> vel,
        ...
        if(parse_out_kind(dtype) == OutKind::F32)
          ...
          return kurtosis_norm_impl<T, double>(pos.data(), vel.data(), mass.data(), n, lbox, nmesh, method, nthreads,
                                               norm_mode);
      },
      py::arg("pos"), py::arg("vel"), py::arg("mass"), py::arg("lbox"), py::arg("nmesh"), py::arg("method") = 3,
      py::arg("norm_mode") = 1, py::arg("nthreads") = 0, py::arg("dtype") = "f4");
